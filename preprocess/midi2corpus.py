...
if __name__ == '__main__':
    ...
    args_parser.add_argument('--input', type=str, default='./jazz-midi/midi_analyzed')
    args_parser.add_argument('--output', type=str, default='./jazz-midi/corpus')
    args = args_parser.parse_args()
    os.makedirs(args.output, exist_ok=True)

    # list files
    midifiles = traverse_dir(args.input, is_pure=True, is_sort=True)
    ...
    for fidx in range(n_files):
        ...
        path_outfile = os.path.join(args.input, path_midi+'.pkl')
        # proc
